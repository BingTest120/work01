...
public class QuizManager : MonoBehaviour
{
    ...
    void LoadQuestions()
    {
        ...
        questions.Add(new QuizQuestion
        {
            question = "7. ภายหลังจากที่มีการประเมินผลงานไปแล้ว จำเป็นต้องมีการแจ้ง\nผลการประเมินนั้นหรือไม่",
            choices = new string[] { 
            ...
            correctAnswerIndex = 1 // ข.จำเป็นเพราะเปิดโอกาสให้ทุกฝ่ายทราบผลและนำไปปรับปรุง
        });
